...
- Gatsby reads source files from the Local GitHub Repository and creates a live preview local Development web site. Any source file edits updates the live preview.

- Git commits the Local GitHub Repository file changes to the remote GitHub Repository.

- Gatsby builds a web site image ready to deploy to the Internet.
...
> [Gatsby](https://www.gatsbyjs.com/) is the best way to create static websites with React. It lets you use React components, but outputs pre-rendered [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML) and [CSS](https://developer.mozilla.org/en-US/docs/Web/HTML) to guarantee the fastest load time.  ...React
...
The Gatsby ``build`` command produces a directory of static web standard [HTML](https://developer.mozilla.org/en-US/docs/Web/HTML), [CSS](https://developer.mozilla.org/en-US/docs/Web/HTML), and [JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript) files that is deployed to a vendor cloud-based  web services. 
